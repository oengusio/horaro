...
class ScheduleVoter extends Voter
{
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        return $subject instanceof Schedule;
    }

    /**
     * @param string            $attribute should only ever be "edit" for now
     * @param \App\Entity\Schedule $subject Typehint deez
    ...
    private function canEdit(Schedule $event, User $user): bool
    {
        return $this->rm->hasRegularAccess($user, $event);
    }

    private function canAdminEdit(Schedule $event, User $user): bool
    {
